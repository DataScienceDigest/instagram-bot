...
def driver_for_account_create():
        ...
        "userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 10_3 like Mac OS X)AppleWebKit/603.1.23 (KHTML, like Gecko) Version/10.0Mobile/14E5239e Safari/602.1" 
        }
...
def driver_for_other_tasks():
        driver_tasks = webdriver.Chrome(options=chrome_options) # Put chrome driver path here!
...
def account_create():
        for i in range(10):
                ...
                print('+++++++++=((((((((((((((((((',value)
                while value == "If you receive any email, it will be shown in here!":
                        sleep(random.randint(1,5))
...
def update_profile(driver):
        ...
        print("bio added")
        sub = WebDriverWait(driver,20).until(EC.presence_of_element_located((By.XPATH,"//button[normalize-space()='Submit']")))
        sleep(2)
        sub.click()
...
def do_posts(driver):
        ...
        def add_button(z):
                ...
                newpost = WebDriverWait(driver,20).until(EC.presence_of_element_located((By.CSS_SELECTOR,"[aria-label='New post']")))
                sleep(2)
                newpost.click()
                print('add search button clicked')
                selectfromcomputer = WebDriverWait(driver,30).until(EC.presence_of_element_located((By.XPATH,"//*[contains(text(), 'Select from computer')]")))
                sleep(2)
                ...
                pyautogui.press("enter")
                print('open pressed')
                next1 = WebDriverWait(driver,20).until(EC.presence_of_element_located((By.XPATH,"//button[normalize-space()='Next']")))
                sleep(2)
                next1.click()
                print("next button clicked")
                next2 = WebDriverWait(driver,20).until(EC.presence_of_element_located((By.XPATH,"//button[normalize-space()='Next']")))
                sleep(2)
                next2.click()
                print("next button2 clicked")
                sleep(5)
                next3 = WebDriverWait(driver,30).until(EC.presence_of_element_located((By.XPATH,"//button[normalize-space()='Share']")))
                next3.click()
                ...
                icone = WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH,'//div[@class="x78zum5 x6s0dn4 xl56j7k xdt5ytf"]/*[name()="svg"][@aria-label="Close"]')))
                sleep(2)
                icone.click()
...
def follow_account(driver,username):
        try:
                WebDriverWait(driver,20).until(EC.presence_of_element_located((By.XPATH,'//div[@class="x9f619 xxk0z11 xvy4d1p x11xpdln xii2z7h x19c4wfv"]/*[name()="svg"][@aria-label="Home"]'))).click()
                print("home button clicked")
                sleep(10)
...
def follow_my_followers(driver):
        print("follow my followers-------------")
        WebDriverWait(driver,20).until(EC.presence_of_element_located((By.XPATH,'//div[@class="x9f619 xxk0z11 xvy4d1p x11xpdln xii2z7h x19c4wfv"]/*[name()="svg"][@aria-label="Home"]'))).click()
        print("home button clicked")
        sleep(10)
        try:
